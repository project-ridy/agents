...
Designer에게 할당되는 화면/디자인 작업은 반드시 다음 정보를 포함해야 합니다.

- GitHub 이슈 번호
- 관련 구현 계획서 또는 디자인 계획 경로
- 관련 docs 디자인 문서 경로(`docs/design/...`)
- Case ID(A/E/X) 또는 화면 상태별 검증 기준
- 산출물 경로/링크와 접근성·반응형 검증 기준

위 정보가 누락된 작업은 수행하지 않고 Orchestrator에 BLOCKED로 보고합니다.
