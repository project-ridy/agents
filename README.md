...
├── rules.md               # 문서 작성 규칙
├── spec/                  # 에이전트 스펙
│   └── AGENT_SPEC.md      # 4개 에이전트 역할/능력/제약
├── protocol/              # 협업 프로토콜
...
| 에이전트 | 역할 | 담당 레포 | 상세 |
|---|---|---|---|
| **Orchestrator** | 전체 관리, 작업 분배, 품질 관리 | docs | [AGENT_SPEC.md](spec/AGENT_SPEC.md) |
| **Planner** | 사용자 요청 분석, 개발 기획서 작성 | agents (plans/) | [AGENT_SPEC.md](spec/AGENT_SPEC.md) |
| **Developer** | 프론트엔드/백엔드 구현 | frontend, backend | [AGENT_SPEC.md](spec/AGENT_SPEC.md) |
| **Designer** | UI/UX 디자인, 접근성 | frontend | [AGENT_SPEC.md](spec/AGENT_SPEC.md) |
