...
├── plans/                           # 에이전트 자체 변경 계획서 (일반 구현 계획은 docs/planning/implementation/)
...
| **Planner** | `planner` | 사용자 요청 분석, 개발 기획서 작성 | docs (planning/implementation), agents (agent plans) | [AGENT_SPEC.md](spec/AGENT_SPEC.md) |
...
| [project-ridy/frontend](https://github.com/project-ridy/frontend) | Next.js 16 + shadcn/ui 프론트엔드 |
| [project-ridy/backend](https://github.com/project-ridy/backend) | NestJS 11 + Prisma 7 백엔드 |
